...
## Last Updated
Tasks D01, E04 — Reactive system permissions via watch stream + lifecycle observer, subjects permission gate with Read guard and CreateSubjectSheet defense-in-depth. Previous: Task E03 — Added confirmation dialogs for destructive system actions. Previous: Task C01 — Fixed logout not navigating away from System Dashboard.