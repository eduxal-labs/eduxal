...
## Last Updated
Task AUTH-C01 — Added `permission_denied_handler.dart` (`showPermissionDenied`, `guardedAction`) — standardized PermissionException snackbar helper. File count: 32 files + 1 subdirectory (`member_creation/`).
